...
function makeQuestion() {
	var pickQuestion = Math.floor(Math.random()*questions.length);
	var question = "Type 'quit' to end the program.\n\n" + questions[pickQuestion].question+" ";
	var answer = questions[pickQuestion].answer;

	rl.question(question, (x) => {
		console.log(answer);
		if (x !== 'quit') {
			setTimeout(makeQuestion,100);
		} else {
			rl.close();
		}
	});
