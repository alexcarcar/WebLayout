...
class Questions {
	...
	private static final String questions [][] = {
		...
		{"Who is one of your state's U.S. Senators now?*", "Kamala Harris (D), Dianne Feinstein (D)."},
		...
		{"Name your U.S. Representative.", "Nancy Pelosi (San Francisco), Barbara Lee (Oakland), Jackie Speier (Hillsborough)"},
		...
		{"What are two Cabinet-level positions?", "Secretary of Agriculture, Commerce, Defense, Education, Energy, Health and Human Services, Homeland Security, Housing and Urban Development, the Interior, Labor, State, Transportation, the Treasury, Veterans Affairs, Attorney General, Vice President"},
		{"What does the judicial branch do?", "reviews and explains laws, resolves disputes (disagreements), decides if a law goes against the Constitution"},
		...
		{"What are two rights of everyone living in the United States?", "freedom of expression, speech, assembly, to petition the government, religion, the right to bear arms"},
		{"What do we show loyalty to when we say the Pledge of Allegiance?", "the United States, the flag"},
		{"What is one promise you make when you become a United States citizen?", "give up loyalty to other countries, defend the Constitution and laws of the United States, obey the laws of the United States, serve in the U.S. military, serve (do important work for) the nation, be loyal to the United States"},
		...
		{"What did the Emancipation Proclamation do?", "freed the slaves in the Confederacy, in the Confederate states, in most Southern states"},
